...
with open(file_to_save, "w") as txt_file:
    ...
    # Determine the count and percentage of votes for each county by looping through the counts.   
    # 6a: Iterate through the county dictionary.   
    for county_name in county_votes:
        ...
        # Create a variable to hold each county's name and votes count and percentage.  
        county_turnout = (
        ...
        if (turnout > highest_turnout) and (turnout_percentage > highest_percentage):
            ...
            highest_percentage = turnout_percentage
            winning_county = county_name
    # 7: Print the county with the largest turnout to the terminal.
    winning_county_summary = (
        f'\n-------------------------\n'
        f'Largest County Turnout: {winning_county}\n'
        # f'Highest voter turnout: {highest_turnout:,}\n'
        # f'Highest turnout percentage: {highest_percentage:.1f}%\n'
        f'-------------------------\n')
